...
export const eventsData: Event[] = [
  ...
  },
  {
    ...
    image: "https://ai-club-oist.netlify.app/assets/TEDx_comp-9dOK_GqP.jpg",
    longDescription: ["Get ready to witness a celebration of ideas, innovation, and inspiration as TEDx makes its return to the Oriental Institute of Science and Technology, Bhopal this November 2025!",
"",
"TEDx events are independently organized under the spirit of `ideas worth spreading`, and this year, we are bringing together a community of brilliant minds — from trailblazing, entrepreneurs to inspiring changemakers — who will share their stories, spark conversations, and ignite new perspectives.",
"",
"🚀 What to Expect:",
"-> A series of thought-provoking talks by diverse speakers (to be revealed soon!)",
"-> A vibrant atmosphere of learning, creativity, and networking",
"-> Interactive sessions and experiences curated to fuel your curiosity",
"",
"📲 Stay connected with us for the latest updates:",
"-> Instagram: @tedxoriental",
"-> Join our WhatsApp Community: Click Here",
"",
"📝 Registration Details: Registrations will open soon! Stay tuned to our official channels for announcements and early access.",
"",
"✨ Let’s come together to shape a future fueled by passion, ideas, and action. See you at TEDx Oriental 2025!",],
    year: "Upcoming"
  },
  // {
  //   id: 4,
